...
function _toConsumableArray(t) {
        ...
        parseRequirements: function(e, i) {
            ...
            if (t.isArray(n)) {
                for (var s = function(t, e) {
                        ...
                        return n
                    }(e, n.length), a = 0; a < s.length; a++) s[a] = o(n[a], s[a]);
                return s
            }
            return t.isPlainObject(n) ? function(t, e, i) {
                ...
                for (var s in t)
                    if (s) {
                        var a = i(s);
                        "string" == typeof a && (a = o(t[s], a)), n[s] = a
                    } else r = o(t[s], e);
                return [r, n]
            }(n, e, i) : [o(n, e)]
        },
    ...
    u.prototype = {
        ...
        addValidator: function(t, e, i) {
            ...
            else if (n.hasOwnProperty(t)) return void r.warn('"' + t + '" is a restricted keyword and is not a valid validator name.');
        ...
        _setValidator: function(t, e, i) {
            for (var r in "object" != typeof e && (e = {
                    fn: e,
                    priority: i
                }), e.validate || (e = new l(e)), this.validators[t] = e, e.messages || {}) this.addMessage(r, t, e.messages[r]);
            return this
        },
    ...
    c.prototype = {
        onSubmitValidate: function(t) {
            var e = this;
            if (!0 !== t.parsley) {
                var i = this._$submitSource || this.$element.find(r._SubmitSelector).first();
        ...
        validate: function(e) {
            ...
            return f[this.whenValidate(e).state()]
        },
        ...
        isValid: function(e) {
            ...
            return f[this.whenValid(e).state()]
        },
        whenValid: function() {
            var e = this,
    ...
    m.prototype = {
        ...
        _parseRequirements: function(t) {
            ...
            this.requirementList = this.validator.parseRequirements(this.requirements, function(i) {
                return t[e.name + (r = i, r[0].toUpperCase() + r.slice(1))];
                var r
            })
        }
    };
    var v = function(e, i, r, n) {
    ...
    w.prototype = {
        init: function(t) {
            return this.__class__ = "Parsley", this.__version__ = "2.4.4", this.__id__ = r.generateID(), this._resetOptions(t), this.$element.is("form") || r.checkAttr(this.$element, this.options.namespace, "validate") && !this.$element.is(this.options.inputs) ? this.bind("parsleyForm") : this.isMultiple() ? this.handleMultiple() : this.bind("parsleyField")
        },
        isMultiple: function() {
        ...
        bind: function(e, i) {
            ...
            switch (e) {
                case "parsleyForm":
                    n = t.extend(new c(this.$element, this.domOptions, this.options), new s, window.ParsleyExtend)._bindFields();
                    break;
                case "parsleyField":
                    n = t.extend(new y(this.$element, this.domOptions, this.options, this.parent), new s, window.ParsleyExtend);
                    break;
                case "parsleyFieldMultiple":
                    n = t.extend(new y(this.$element, this.domOptions, this.options, this.parent), new _, new s, window.ParsleyExtend)._init();
                    break;
                default:
                    throw new Error(e + "is not a supported Parsley type")
            }
            return this.options.multiple && r.setAttr(this.$element, this.options.namespace, "multiple", this.options.multiple), void 0 !== i ? (this.$element.data("ParsleyFieldMultiple", n), n) : (this.$element.data("Parsley", n), n._actualizeTriggers(), n._trigger("init"), n)
        }
    };
    var b = t.fn.jquery.split(".");
    if (parseInt(b[0]) <= 1 && parseInt(b[1]) < 8) throw "The loaded version of jQuery is too old. Please upgrade to 1.8.x or better.";
    b.forEach || r.warn("Parsley requires ES5 to run properly. Please include https://github.com/es-shims/es5-shim");
    var F = t.extend(new s, {
        $element: t(document),
    ...
    t.extend(y.prototype, p.Field, s.prototype), t.extend(c.prototype, p.Form, s.prototype), t.extend(w.prototype, s.prototype), t.fn.parsley = t.fn.psly = function(e) {
        if (this.length > 1) {
            var i = [];
        ...
        if (t(this).length) return new w(this, e);
        r.warn("You must bind Parsley on an existing element.")
    }, void 0 === window.ParsleyExtend && (window.ParsleyExtend = {}), F.options = t.extend(r.objectCreate(n), window.ParsleyConfig), window.ParsleyConfig = F.options, window.Parsley = window.psly = F, window.ParsleyUtils = r;
    var C = window.Parsley._validatorRegistry = new u(window.ParsleyConfig.validators, window.ParsleyConfig.i18n);
    window.ParsleyValidator = {}, t.each("setLocale addCatalog addMessage addMessages getErrorMessage formatMessage addValidator updateValidator removeValidator".split(" "), function(e, i) {
        window.Parsley[i] = t.proxy(C, i), window.ParsleyValidator[i] = function() {
            var t;
        ...
        removeError: function(t, e, i) {
            var n = !0 !== i;
            return r.warnOnce("Accessing ParsleyUI is deprecated. Call 'removeError' on the instance directly. Please comment in issue 1073 as to your need to call this method."), t.removeError(e, {
                updateClass: n
            })
        },
        getErrorsMessages: function(t) {
            return r.warnOnce("Accessing ParsleyUI is deprecated. Call 'getErrorsMessages' on the instance directly."), t.getErrorsMessages()
        }
    }, t.each("addError updateError".split(" "), function(t, e) {
        window.ParsleyUI[e] = function(t, i, n, s, a) {
            var o = !0 !== a;
            return r.warnOnce("Accessing ParsleyUI is deprecated. Call '" + e + "' on the instance directly. Please comment in issue 1073 as to your need to call this method."), t[e](i, {
                message: n,
                assert: s,
                updateClass: o
            })
    ...
    return t.listen = function(t, e) {
        ...
        window.Parsley.on(V(t), E(e, i))
    }, t.listenTo = function(t, e, i) {
        if (x(), !(t instanceof y || t instanceof c)) throw new Error("Must give Parsley instance");
        ...
        var i;
        x();
        var r = e instanceof y || e instanceof c,
            n = Array.prototype.slice.call(arguments, r ? 2 : 1);
        n.unshift(V(t)), r || (e = window.Parsley), (i = e).trigger.apply(i, _toConsumableArray(n))
    }, t.extend(!0, F, {
        asyncValidators: {
            default: {
                fn: function(t) {
        ...
        validateString: function(e, i, r, n) {
            ...
            if (void 0 === F.asyncValidators[l]) throw new Error("Calling an undefined async validator: `" + l + "`");
            (i = F.asyncValidators[l].url || i).indexOf("{value}") > -1 ? i = i.replace("{value}", encodeURIComponent(e)) : o[n.$element.attr("name") || n.$element.attr("id")] = e;
            var u = t.extend(!0, r.options || {}, F.asyncValidators[l].options);
            s = t.extend(!0, {}, {
                url: i,
                data: o,
                type: "GET"
            }, u), n.trigger("field:ajaxoptions", n, s), a = t.param(s), void 0 === F._remoteCache && (F._remoteCache = {});
            var h = F._remoteCache[a] = F._remoteCache[a] || t.ajax(s),
                d = function() {
                    var e = F.asyncValidators[l].fn.call(n, h, i, r);
